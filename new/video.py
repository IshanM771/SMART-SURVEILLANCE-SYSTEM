...
# Input video file path from the user
...
if not os.path.exists(video_file):
    ...
    # Initialize and start the video frame capture from the provided video file
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            if Id == 1:
                Id = "Ishan {0:.2f}%".format(round(100 - confidence, 2))
                # Put text describe who is in the picture
            elif Id == 2:
                Id = "Amogh {0:.2f}%".format(round(100 - confidence, 2))
                # Put text describe who is in the picture
            elif Id == 3:
                Id = "Niraj {0:.2f}%".format(round(100 - confidence, 2))
            else:
                pass
